...
final shellNavigatorCategoryKey = GlobalKey<NavigatorState>(debugLabel: 'shellCategory');
final shellNavigatorCommunityKey = GlobalKey<NavigatorState>(debugLabel: 'shellCommunity');
