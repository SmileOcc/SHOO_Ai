...
abstract final class SHOMockRouteRegistry {
  static final List<SHOMockRouteEntry> _routes = [
    ...
    const SHOMockRouteEntry(method: 'GET', path: '/products/{id}', asset: 'assets/mock/product_detail.json'),
    ...
    const SHOMockRouteEntry(method: 'GET', path: '/products/{id}/reviews', asset: 'assets/mock/product_reviews.json'),
