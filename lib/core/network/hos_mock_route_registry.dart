...
abstract final class SHOMockRouteRegistry {
  static final List<SHOMockRouteEntry> _routes = [
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/banners',
      asset: 'assets/mock/banners.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/products',
    ...
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/categories',
      asset: 'assets/mock/categories.json',
    ),
    const SHOMockRouteEntry(
      method: 'POST',
      path: '/auth/login',
      asset: 'assets/mock/auth_login.json',
    ),
    const SHOMockRouteEntry(
      method: 'POST',
      path: '/auth/register',
    ...
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/auth/profile',
      asset: 'assets/mock/auth_profile.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/products/{id}',
    ...
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/cart',
      asset: 'assets/mock/cart.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/messages',
      asset: 'assets/mock/messages.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/marketing/activity-popup',
      asset: 'assets/mock/activity_popup.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
    ...
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/documents',
      asset: 'assets/mock/documents.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/app/version',
      asset: 'assets/mock/app_version.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/search/hot',
      asset: 'assets/mock/search_hot.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/search',
      asset: 'assets/mock/search.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/products/{id}/reviews',
      asset: 'assets/mock/product_reviews_catalog.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/coupons',
      asset: 'assets/mock/coupons.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/after-sales',
      asset: 'assets/mock/after_sales.json',
    ),
    const SHOMockRouteEntry(
      method: 'POST',
      path: '/after-sales',
      asset: 'assets/mock/after_sale_create.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/addresses',
    ...
    const SHOMockRouteEntry(
      method: 'POST',
      path: '/orders/{id}/pay',
      asset: 'assets/mock/payment_success.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/orders',
      asset: 'assets/mock/orders.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/orders/{id}',
      asset: 'assets/mock/order_detail.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/orders/{id}/logistics',
      asset: 'assets/mock/order_logistics.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/community/feed',
      asset: 'assets/mock/community_feed.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/activity/data',
      asset: 'assets/mock/activity_data.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/activity/detail',
      asset: 'assets/mock/activity_detail.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/activity/detail/level3',
      asset: 'assets/mock/activity_level3_detail.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/activity/user/check',
      asset: 'assets/mock/activity_user_check.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/activity/config/url-rules',
      asset: 'assets/mock/activity_url_rules.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/flash-sale/calendar',
      asset: 'assets/mock/flash_sale_catalog.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/flash-sale/page',
      asset: 'assets/mock/flash_sale_catalog.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/flash-sale/product-activity',
      asset: 'assets/mock/flash_sale_catalog.json',
    ),
    const SHOMockRouteEntry(
      method: 'GET',
      path: '/flash-sale/follows',
      asset: 'assets/mock/flash_sale_follows.json',
    ),
    const SHOMockRouteEntry(
      method: 'POST',
      path: '/flash-sale/follow',
      asset: 'assets/mock/flash_sale_follow_ok.json',
    ),
    const SHOMockRouteEntry(
      method: 'POST',
