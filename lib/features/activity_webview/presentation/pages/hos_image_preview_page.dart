...
class SHOImagePreviewPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SHOImagePreviewPage> createState() =>
      _SHOImagePreviewPageState();
}
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () =>
                              Share.share(images[state.currentIndex].url),
                          child: const Text(
                            '分享图片',
                            style: TextStyle(color: Colors.white),
                          ),
                        ...
                        TextButton(
                          onPressed: () =>
                              context.showToast(images[state.currentIndex].url),
                          child: const Text(
                            '查看原图',
                            style: TextStyle(color: Colors.white),
                          ),
