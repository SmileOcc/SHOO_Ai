  ...
  Widget build(BuildContext context) {
    return SHOCommunityFeedCard(
      ...
      child: switch (item.adStyle) {
        SHOCommunityAdStyle.banner => _BannerAd(item: item),
        SHOCommunityAdStyle.nativeProduct => _NativeProductAd(item: item),
        SHOCommunityAdStyle.brandStory => _BrandStoryAd(item: item),
        SHOCommunityAdStyle.carousel => _CarouselAd(item: item),
        null => _BannerAd(item: item),
      },
    );
  }
}
...
class _BannerAd extends StatelessWidget {
  const _BannerAd({required this.item});
...
class _NativeProductAd extends StatelessWidget {
  const _NativeProductAd({required this.item});
...
class _BrandStoryAd extends StatelessWidget {
  const _BrandStoryAd({required this.item});
...
class _CarouselAd extends StatefulWidget {
  const _CarouselAd({required this.item});
